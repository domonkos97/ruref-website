function TitleCards( {isVisible} ) {
    return (
        <div className={`title flex flex-col justify-between items-center z-0 ${isVisible ? 'show': 'hidden'}`}>
            <div className="relative">
                <p className="big-text syne font-black double-text-color text-center tracking-wide w-1/2 ">ruref</p>
